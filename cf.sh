...
if [ "${type}" = "vmess" ] ; then
	if [ "${network}" = "ws" ] ; then
		if [ "${wss0rtt}" = "1" ] ; then
			if [ "${tls}" = "1" ] ; then
				echo "- { name: "\'${name}-${country}-${cdn_ip}-${cdn_loss}%-${cdn_ms}ms${extraname}\'", type: "\'${type}\'", server: "\'${cdn_ip}\'", port: "\'${port}\'", uuid: "\'${uuid}\'", alterId: 0, cipher: "\'${cipher}\'", udp: true, xudp: true, tls: true, servername: "\'${server}\'", skip-cert-verify: "${skiptls}",${fingerprint} tfo: "${tfo}", mptcp: "${mptcp}", ip-version: "\'${ipversion}\'", network: "\'${network}\'", ws-opts: { path: "\'${path}?ed=2048\'", headers: { Host: "\'${server}\'" }, v2ray-http-upgrade: "${v2rayhttpupgrade}" }, smux: { enabled: "${mux_status}", protocol: "\'${mux_type}\'", padding: "${padding}", max-connections: "\'${max_connections}\'", min-streams: "\'${min_streams}\'", max-streams: "\'${max_streams}\'", statistic: "${statistic}", only-tcp: "${only_tcp}" } }" >> $dir_tmp/${c}_${filename}
			else
				echo "- { name: "\'${name}-${country}-${cdn_ip}-${cdn_loss}%-${cdn_ms}ms${extraname}\'", type: "\'${type}\'", server: "\'${cdn_ip}\'", port: "\'${port}\'", uuid: "\'${uuid}\'", alterId: 0, cipher: "\'${cipher}\'", udp: true, xudp: true, tfo: "${tfo}", mptcp: "${mptcp}", ip-version: "\'${ipversion}\'", network: "\'${network}\'", ws-opts: { path: "\'${path}?ed=2048\'", headers: { Host: "\'${server}\'" }, v2ray-http-upgrade: "${v2rayhttpupgrade}" }, smux: { enabled: "${mux_status}", protocol: "\'${mux_type}\'", padding: "${padding}", max-connections: "\'${max_connections}\'", min-streams: "\'${min_streams}\'", max-streams: "\'${max_streams}\'", statistic: "${statistic}", only-tcp: "${only_tcp}" } }" >> $dir_tmp/${c}_${filename}
			fi
		else
			if [ "${tls}" = "1" ] ; then
				echo "- { name: "\'${name}-${country}-${cdn_ip}-${cdn_loss}%-${cdn_ms}ms${extraname}\'", type: "\'${type}\'", server: "\'${cdn_ip}\'", port: "\'${port}\'", uuid: "\'${uuid}\'", alterId: 0, cipher: "\'${cipher}\'", udp: true, xudp: true, tls: true, servername: "\'${server}\'", skip-cert-verify: "${skiptls}",${fingerprint} tfo: "${tfo}", mptcp: "${mptcp}", ip-version: "\'${ipversion}\'", network: "\'${network}\'", ws-opts: { path: "\'${path}\'", headers: { Host: "\'${server}\'" }, v2ray-http-upgrade: "${v2rayhttpupgrade}" }, smux: { enabled: "${mux_status}", protocol: "\'${mux_type}\'", padding: "${padding}", max-connections: "\'${max_connections}\'", min-streams: "\'${min_streams}\'", max-streams: "\'${max_streams}\'", statistic: "${statistic}", only-tcp: "${only_tcp}" } }" >> $dir_tmp/${c}_${filename}
			else
				echo "- { name: "\'${name}-${country}-${cdn_ip}-${cdn_loss}%-${cdn_ms}ms${extraname}\'", type: "\'${type}\'", server: "\'${cdn_ip}\'", port: "\'${port}\'", uuid: "\'${uuid}\'", alterId: 0, cipher: "\'${cipher}\'", udp: true, xudp: true, tfo: "${tfo}", mptcp: "${mptcp}", ip-version: "\'${ipversion}\'", network: "\'${network}\'", ws-opts: { path: "\'${path}\'", headers: { Host: "\'${server}\'" }, v2ray-http-upgrade: "${v2rayhttpupgrade}" }, smux: { enabled: "${mux_status}", protocol: "\'${mux_type}\'", padding: "${padding}", max-connections: "\'${max_connections}\'", min-streams: "\'${min_streams}\'", max-streams: "\'${max_streams}\'", statistic: "${statistic}", only-tcp: "${only_tcp}" } }" >> $dir_tmp/${c}_${filename}
			fi
		fi
	...
	if [ "${network}" = "ws" ] ; then
		if [ "${wss0rtt}" = "1" ] ; then
			if [ "${tls}" = "1" ] ; then
				echo "- { name: "\'${name}-${country}-${cdn_ip}-${cdn_loss}%-${cdn_ms}ms${extraname}\'", type: "\'${type}\'", server: "\'${cdn_ip}\'", port: "\'${port}\'", uuid: "\'${uuid}\'", udp: true, xudp: true, tls: true, servername: "\'${server}\'", skip-cert-verify: "${skiptls}",${fingerprint} tfo: "${tfo}", mptcp: "${mptcp}", ip-version: "\'${ipversion}\'", network: "\'${network}\'", ws-opts: { path: "\'${path}?ed=2048\'", headers: { Host: "\'${server}\'" }, v2ray-http-upgrade: "${v2rayhttpupgrade}" }, smux: { enabled: "${mux_status}", protocol: "\'${mux_type}\'", padding: "${padding}", max-connections: "\'${max_connections}\'", min-streams: "\'${min_streams}\'", max-streams: "\'${max_streams}\'", statistic: "${statistic}", only-tcp: "${only_tcp}" } }" >> $dir_tmp/${c}_${filename}
			else
				echo "- { name: "\'${name}-${country}-${cdn_ip}-${cdn_loss}%-${cdn_ms}ms${extraname}\'", type: "\'${type}\'", server: "\'${cdn_ip}\'", port: "\'${port}\'", uuid: "\'${uuid}\'", udp: true, xudp: true, tfo: "${tfo}", mptcp: "${mptcp}", ip-version: "\'${ipversion}\'", network: "\'${network}\'", ws-opts: { path: "\'${path}?ed=2048\'", headers: { Host: "\'${server}\'" }, v2ray-http-upgrade: "${v2rayhttpupgrade}" }, smux: { enabled: "${mux_status}", protocol: "\'${mux_type}\'", padding: "${padding}", max-connections: "\'${max_connections}\'", min-streams: "\'${min_streams}\'", max-streams: "\'${max_streams}\'", statistic: "${statistic}", only-tcp: "${only_tcp}" } }" >> $dir_tmp/${c}_${filename}
			fi
		else
			if [ "${tls}" = "1" ] ; then
				echo "- { name: "\'${name}-${country}-${cdn_ip}-${cdn_loss}%-${cdn_ms}ms${extraname}\'", type: "\'${type}\'", server: "\'${cdn_ip}\'", port: "\'${port}\'", uuid: "\'${uuid}\'", udp: true, xudp: true, tls: true, servername: "\'${server}\'", skip-cert-verify: "${skiptls}",${fingerprint} tfo: "${tfo}", mptcp: "${mptcp}", ip-version: "\'${ipversion}\'", network: "\'${network}\'", ws-opts: { path: "\'${path}\'", headers: { Host: "\'${server}\'" }, v2ray-http-upgrade: "${v2rayhttpupgrade}" }, smux: { enabled: "${mux_status}", protocol: "\'${mux_type}\'", padding: "${padding}", max-connections: "\'${max_connections}\'", min-streams: "\'${min_streams}\'", max-streams: "\'${max_streams}\'", statistic: "${statistic}", only-tcp: "${only_tcp}" } }" >> $dir_tmp/${c}_${filename}
	...
	if [ "${network}" = "ws" ] ; then
		if [ "${wss0rtt}" = "1" ] ; then
			echo "- { name: "\'${name}-${country}-${cdn_ip}-${cdn_loss}%-${cdn_ms}ms${extraname}\'", type: "\'${type}\'", server: "\'${cdn_ip}\'", port: "\'${port}\'", password: "\'${uuid}\'", udp: true, tls: true, sni: "\'${server}\'", skip-cert-verify: "${skiptls}",${fingerprint} tfo: "${tfo}", mptcp: "${mptcp}", ip-version: "\'${ipversion}\'", network: "\'${network}\'", ws-opts: { path: "\'${path}?ed=2048\'", headers: { Host: "\'${server}\'" }, v2ray-http-upgrade: "${v2rayhttpupgrade}" }, smux: { enabled: "${mux_status}", protocol: "\'${mux_type}\'", padding: "${padding}", max-connections: "\'${max_connections}\'", min-streams: "\'${min_streams}\'", max-streams: "\'${max_streams}\'", statistic: "${statistic}", only-tcp: "${only_tcp}" } }" >> $dir_tmp/${c}_${filename}
		else
			echo "- { name: "\'${name}-${country}-${cdn_ip}-${cdn_loss}%-${cdn_ms}ms${extraname}\'", type: "\'${type}\'", server: "\'${cdn_ip}\'", port: "\'${port}\'", password: "\'${uuid}\'", udp: true, tls: true, sni: "\'${server}\'", skip-cert-verify: "${skiptls}",${fingerprint} tfo: "${tfo}", mptcp: "${mptcp}", ip-version: "\'${ipversion}\'", network: "\'${network}\'", ws-opts: { path: "\'${path}\'", headers: { Host: "\'${server}\'" }, v2ray-http-upgrade: "${v2rayhttpupgrade}" }, smux: { enabled: "${mux_status}", protocol: "\'${mux_type}\'", padding: "${padding}", max-connections: "\'${max_connections}\'", min-streams: "\'${min_streams}\'", max-streams: "\'${max_streams}\'", statistic: "${statistic}", only-tcp: "${only_tcp}" } }" >> $dir_tmp/${c}_${filename}
		fi
	elif [ "${network}" = "grpc" ] ; then
	...
	if [ "${network}" = "ws" ] ; then
		if [ "${wss0rtt}" = "1" ] ; then
			if [ "${tls}" = "1" ] ; then
				echo "- { name: "\'${name}-${country}-${cdn_ip}-${cdn_loss}%-${cdn_ms}ms${extraname}\'", type: "\'${type}\'", server: "\'${cdn_ip}\'", port: "\'${port}\'", password: "\'${password}\'", cipher: "\'${cipher}\'", udp: true, udp-over-tcp: true, tls: true, skip-cert-verify: "${skiptls}",${fingerprint} tfo: "${tfo}", mptcp: "${mptcp}", ip-version: "\'${ipversion}\'", plugin: v2ray-plugin, plugin-opts: { mode: websocket, host: "\'${server}\'", path: "\'${path}?ed=2048\'", v2ray-http-upgrade: "${v2rayhttpupgrade}" }, smux: { enabled: "${mux_status}", protocol: "\'${mux_type}\'", padding: "${padding}", max-connections: "\'${max_connections}\'", min-streams: "\'${min_streams}\'", max-streams: "\'${max_streams}\'", statistic: "${statistic}", only-tcp: "${only_tcp}" } }" >> $dir_tmp/${c}_${filename}
			else
				echo "- { name: "\'${name}-${country}-${cdn_ip}-${cdn_loss}%-${cdn_ms}ms${extraname}\'", type: "\'${type}\'", server: "\'${cdn_ip}\'", port: "\'${port}\'", password: "\'${password}\'", cipher: "\'${cipher}\'", udp: true, udp-over-tcp: true, tfo: "${tfo}", mptcp: "${mptcp}", ip-version: "\'${ipversion}\'", plugin: v2ray-plugin, plugin-opts: { mode: websocket, host: "\'${server}\'", path: "\'${path}?ed=2048\'", v2ray-http-upgrade: "${v2rayhttpupgrade}" }, smux: { enabled: "${mux_status}", protocol: "\'${mux_type}\'", padding: "${padding}", max-connections: "\'${max_connections}\'", min-streams: "\'${min_streams}\'", max-streams: "\'${max_streams}\'", statistic: "${statistic}", only-tcp: "${only_tcp}" } }" >> $dir_tmp/${c}_${filename}
			fi
		else
			if [ "${tls}" = "1" ] ; then
				echo "- { name: "\'${name}-${country}-${cdn_ip}-${cdn_loss}%-${cdn_ms}ms${extraname}\'", type: "\'${type}\'", server: "\'${cdn_ip}\'", port: "\'${port}\'", password: "\'${password}\'", cipher: "\'${cipher}\'", udp: true, udp-over-tcp: true, tls: true, skip-cert-verify: "${skiptls}",${fingerprint} tfo: "${tfo}", mptcp: "${mptcp}", ip-version: "\'${ipversion}\'", plugin: v2ray-plugin, plugin-opts: { mode: websocket, host: "\'${server}\'", path: "\'${path}\'", v2ray-http-upgrade: "${v2rayhttpupgrade}" }, smux: { enabled: "${mux_status}", protocol: "\'${mux_type}\'", padding: "${padding}", max-connections: "\'${max_connections}\'", min-streams: "\'${min_streams}\'", max-streams: "\'${max_streams}\'", statistic: "${statistic}", only-tcp: "${only_tcp}" } }" >> $dir_tmp/${c}_${filename}
			else
				echo "- { name: "\'${name}-${country}-${cdn_ip}-${cdn_loss}%-${cdn_ms}ms${extraname}\'", type: "\'${type}\'", server: "\'${cdn_ip}\'", port: "\'${port}\'", password: "\'${password}\'", cipher: "\'${cipher}\'", udp: true, udp-over-tcp: true, tfo: "${tfo}", mptcp: "${mptcp}", ip-version: "\'${ipversion}\'", plugin: v2ray-plugin, plugin-opts: { mode: websocket, host: "\'${server}\'", path: "\'${path}\'", v2ray-http-upgrade: "${v2rayhttpupgrade}" }, smux: { enabled: "${mux_status}", protocol: "\'${mux_type}\'", padding: "${padding}", max-connections: "\'${max_connections}\'", min-streams: "\'${min_streams}\'", max-streams: "\'${max_streams}\'", statistic: "${statistic}", only-tcp: "${only_tcp}" } }" >> $dir_tmp/${c}_${filename}
			fi
		fi
...
[ -z "${wss0rtt}" ] && wss0rtt=1
#http-upgrade，默认关闭0
if [ "${httpupgrade}" = "1" ] ; then v2rayhttpupgrade=true && extraname="-httpupgrade" ; else v2rayhttpupgrade=false && extraname="" ; fi
#tls，是否启用tls加密，默认开启
[ -z "${tls}" ] && tls=1
